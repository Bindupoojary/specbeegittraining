...
class CustomConfigForm extends ConfigFormBase {
   ...
   * Settings Variable.
   */
  const CONFIGNAME = "binduu_exercise.settings";
  // The constant CONFIGNAME is declared.
  // With a value of "binduu_exercise.settings".
  ...
  public function getFormId() {
    ...
    return "binduu_exercise_settings";
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['fullname'] = [
      ...
      '#attached' => [
              // Attaches CSS library binduu_exercise/css_lib to form element.
              // Which allows the styles defined in that library.
              // To be applied to the element.
        'library' => [
          'binduu_exercise/css_lib',
        ],
      ],
